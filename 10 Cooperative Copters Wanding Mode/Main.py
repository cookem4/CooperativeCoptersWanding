...
if (__name__ == '__main__'):
    ...
    EStop_failsafe = EStop('COM15', 115200)                   #EStop object. When pressed, EStop disarms FC & puts in failsafe mode.
    ...
    cleanflightMSP1 = Cleanflight_MSP('COM8', 115200)            #MSP object. Packages messages in the MSP Protocal.
  #  cleanflightMSP2 = Cleanflight_MSP('COM8', 115200)          #MSP object. Packages messages in the MSP Protocal.
