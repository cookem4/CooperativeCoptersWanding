...
class PB_Control():
    ...
    #kPos = [[0.5,0.3,0.5,0.3,0.3,0.23]]
    kPos = [[0.5,0.3,0.5,0.3,0.3,0.23], [0.5,0.3,0.5,0.3,0.3,0.23]] #[[kpx, kpy, kpz, kdx, ...], [], ...]. This list includes the PD gains of all copters as well as the nominal gravity compensating thrust. Each copter gains are given in a sublist.
